      ...
      <main className='footer-main'>
        ...
        <section className='clmn-4'>
          ...
          <ul>
            ...
            <li><a href='https://api.whatsapp.com/send/?phone=96181909322&text&type=phone_number&app_absent=0'>WhatsApp</a></li>
          </ul>
        </section>
      </main>
      <p className='copyright'>Copyright © 2023 Dayaa Store All rights reserved</p>
    </footer>
  );
}
